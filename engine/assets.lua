...
Assets.init = function()
    ...
    Assets.floor1 = {}
    local x, y = 96, 16
    Assets.floor1[1] = createQuad(x, y)
    Assets.floor1[2] = createQuad(x + 16, y)
    Assets.floor1[3] = createQuad(x + 32, y)
    Assets.floor1[4] = createQuad(x, y + 16)
    Assets.floor1[5] = createQuad(x + 32, y + 16)
    Assets.floor1[6] = createQuad(x, y + 32)
    Assets.floor1[7] = createQuad(x + 32, y + 32)
    Assets.floor1_grid = createQuad(x + 16, y + 16) -- EXIT

    Assets.floor2 = {}
    x, y = 352, 48
    Assets.floor2[1] = createQuad(x, y)
    Assets.floor2[2] = createQuad(x + 16, y)
    Assets.floor2[3] = createQuad(x + 32, y)
    Assets.floor2[4] = createQuad(x, y + 16)
    Assets.floor2[5] = createQuad(x + 32, y + 16)
    Assets.floor2[6] = createQuad(x, y + 32)
    Assets.floor2[7] = createQuad(x + 32, y + 32)
    Assets.floor2_grid = createQuad(x + 16, y + 16) -- EXIT

    Assets.floor3 = {}
    x, y = 400, 48
    Assets.floor3[1] = createQuad(x, y)
    Assets.floor3[2] = createQuad(x + 16, y)
    Assets.floor3[3] = createQuad(x + 32, y)
    Assets.floor3[4] = createQuad(x, y + 16)
    Assets.floor3[5] = createQuad(x + 32, y + 16)
    Assets.floor3[6] = createQuad(x, y + 32)
    Assets.floor3[7] = createQuad(x + 32, y + 32)
    Assets.floor3_grid = createQuad(x + 16, y + 16) -- EXIT
