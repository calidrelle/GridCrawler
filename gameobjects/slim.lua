...
ItemManager.newSlim = function(tileX, tileY)
    ...
    item.animIdle = require("images.animation").createNew(Assets.slime_idle_anim, 6, 0.1)
    item.animRun = require("images.animation").createNew(Assets.slime_run_anim, 6, 0.1)
